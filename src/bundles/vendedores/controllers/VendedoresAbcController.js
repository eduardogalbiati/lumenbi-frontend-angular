app.controller('VendedoresAbcController',['$scope','VendedoresService', '$q', '$timeout', function( $scope , VendedoresService, $q, $timeout) {
...
/*
    ...
    */
    ...
    {
        VendedoresService.getCurvaAbc($scope.abcParametros.mes, $scope.abcParametros.ano, $scope.abcParametros.interval).then(function(data) {
            $scope.abcData = data;
        });
    }
    ...
    {
        VendedoresService.getCurvaAbcHead($scope.mesAtual, $scope.abcParametros.ano, '1').then(function(data) {
