app.controller('FornecedoresAbcController',['$scope','FornecedoresService', '$q', '$timeout', function( $scope , FornecedoresService, $q, $timeout) {
...
/*
    ...
    */
    ...
    {
        FornecedoresService.getCurvaAbc($scope.abcParametros.mes, $scope.abcParametros.ano, $scope.abcParametros.interval).then(function(data) {
            $scope.abcData = data;
        });
    }
    ...
    {
        FornecedoresService.getCurvaAbcHead($scope.mesAtual, $scope.abcParametros.ano, '1').then(function(data) {
