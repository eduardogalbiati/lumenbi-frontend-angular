app.controller('ClientesAbcController',['$scope','ClientesService', '$q', '$timeout', function( $scope , ClientesService, $q, $timeout) {
...
/*
    ...
    */
    ...
    {
        ClientesService.getCurvaAbc($scope.abcParametros.mes, $scope.abcParametros.ano, $scope.abcParametros.interval).then(function(data) {
            $scope.abcData = data;
        });
    }
    ...
    {
        ClientesService.getCurvaAbcHead($scope.mesAtual, $scope.abcParametros.ano, '1').then(function(data) {
