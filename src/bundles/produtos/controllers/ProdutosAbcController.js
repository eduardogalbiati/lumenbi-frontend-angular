app.controller('ProdutosAbcController',['$scope','ProdutosService', '$q', '$timeout', function( $scope , ProdutosService, $q, $timeout) {
...
/*
    ...
    */
    ...
    {
        ProdutosService.getCurvaAbc($scope.abcParametros.mes, $scope.abcParametros.ano, $scope.abcParametros.interval).then(function(data) {
            $scope.abcData = data;
        });
    }
    ...
    {
        ProdutosService.getCurvaAbcHead($scope.mesAtual, $scope.abcParametros.ano, '1').then(function(data) {
